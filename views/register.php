        ...
        <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
            <div class="flex-1">
                <div class="text-center">
                    ...
                    <p class="mt-3 text-gray-500 dark:text-gray-300">Sign up</p>
                </div>
                ...
                <div class="mt-8">
                    <form method="post">
                        <div>
                            ...
                            <input name="username" id="username" placeholder="Username" value="<?= isset($_POST['username']) ? htmlspecialchars($_POST['username']) : '' ?>" class="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                            <span class="text-sm text-red-600"><?= $errors['username'] ? htmlspecialchars($errors['username']) : '' ?></span>
                        </div>
                        ...
                        <div class="mt-6">
                            <div class="flex justify-between mb-2">
                                <label for="password_confirm" class="text-sm text-gray-600 dark:text-gray-200">Confirm Password</label>
                            </div>
                            <input type="password" name="password_confirm" id="password_confirm" placeholder="Confirm Password" class="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                            <span class="text-sm text-red-600"><?= $errors['password_confirm'] ? htmlspecialchars($errors['password_confirm']) : '' ?></span>
                        </div>
                    ...
                    <p class="mt-6 text-sm text-center text-gray-400">Have an account yet? <a href="/login" class="text-blue-500 focus:outline-none focus:underline hover:underline">Login</a>.</p>
                </div>
            </div>
        </div>
    </div>
