...
<div class="grid gap-6 grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-10">
    ...
    <form method="post" action="/favorites/delete">
        <div class="relative">
            <a href="/movie?id=<?= htmlspecialchars($movie->movie_id) ?>">
            ...
            <div class="container text-sm">
                <div class="flex justify-between">
                    ...
                    <span><?= htmlspecialchars(round($movie->vote_average, 1)) ?><i
                                class="text-yellow-500 not-italic ml-1">★</i></span>
                </div>
...
<div class="flex justify-center mt-5">
    <?php if ($getPage > 1): ?>
        <a href="/favorites?page=<?= $getPage - 1 ?>"
